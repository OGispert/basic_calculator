              ...
              Row(
                ...
                children: [
                  ...
                  CalculatorButton(
                    text: '+/-',
                    bgColor: Color(0xffA5A5A5),
                    onPressed: () => calculatorCtrl.changePositiveNegative(),
                  ),
                  CalculatorButton(
                    text: 'del',
                    bgColor: Color(0xffA5A5A5),
                    onPressed: () => calculatorCtrl.deleteLast(),
                  ),
                  CalculatorButton(
                    text: '/',
                    bgColor: Color(0xffF0A23B),
                    onPressed: () => calculatorCtrl.addOperation('/'),
                  ),
                ],
              ),
              Row(
                ...
                children: [
                  ...
                  CalculatorButton(
                    text: 'X',
                    bgColor: Color(0xffF0A23B),
                    onPressed: () => calculatorCtrl.addOperation('X'),
                  ),
                ],
              ),
              Row(
              ...
              Row(
                ...
                children: [
                  ...
                  CalculatorButton(
                    text: '=',
                    bgColor: Color(0xffF0A23B),
                    onPressed: () => calculatorCtrl.doTheMath(),
                  ),
                ],
              ),
            ],
